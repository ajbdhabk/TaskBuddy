...
export default function App() {
  ...
  return (
    <ImageBackground
      source={require('./assets/Sunset.jpg')} // Update the path accordingly
      style={styles.background}
    >
      <View style={styles.container}>
        <Text style={styles.heading}>TaskBuddy</Text>
...
const styles = StyleSheet.create({
  ...
  container: {
    flex: 1,
    backgroundColor: 'rgba(0, 0, 0, 0.4)', // Add an overlay to make text more readable
  },
  heading: {
    color: 'pink',
    fontSize: 50,
